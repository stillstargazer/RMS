...
public class EditWindow extends JFrame
{
	...
	public EditWindow(ReagentList rl, int n, JTable reagentTable)
	{
		super("编辑药品");
		setResizable(false);
		...
		CHInametextfield = new JTextField(rl.get(n).getCHIname(), 10);
		...
		ENGnametextfield = new JTextField(rl.get(n).getENGname(), 10);
		...
		CAStextfield = new JTextField(rl.get(n).getCAS(), 10);
		...
		numbertextfield = new JTextField(String.valueOf(rl.get(n).getnumber()), 10);
		...
		puritytextfield = new JTextField(rl.get(n).getpurity(), 10);
		...
		spectextfield.setSelectedItem(rl.get(n).getspecification());
		...
		manutextfield.setSelectedItem(rl.get(n).getmanufacturer());
		...
		datetextfield = new JTextField(String.valueOf(rl.get(n).getdate()), 10);
